...
# Consultar datos
fields = ["temperature", "humidity", "uv_index"]
...
with col3:
    ...
    if "uv_index" in data_df.columns and not data_df.empty:
        st.plotly_chart(px.line(data_df, x="time", y="uv_index", title="Índice UV"), use_container_width=True)
    else:
